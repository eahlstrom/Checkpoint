module Checkpoint::NetworkObject
  class Host_ckp
    ...
    def initialize(object_hash)
      ...
      needed_keys =  [:type, :management, :primary_management, :name, :log_server]
      needed_keys += [:comments, :firewall, :ipaddr, :interfaces, :class_name]
    ...
    def match(match_obj)
      ...
      if match_obj.type == :ip
        ...
        @interfaces.each do |interface|
          return true if interface.match(match_obj)
        end
