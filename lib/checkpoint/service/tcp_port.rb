class Checkpoint::Service::TCPport
  attr_reader :name
  ...
  def initialize(object_hash)
    ...
    needed_keys = [ :type, :port, :class_name, :name, :proto_type_name, :comments, :enable_tcp_resource, :include_in_any ]
  ...
  #
  #   ssh.match Checkpoint::Service::Matcher.new_s('tcp:22') => true
  #
  def match(match_obj)
    ...
    return false if match_obj.proto != 6
